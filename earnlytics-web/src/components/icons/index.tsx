...
export function WindowIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LayoutGridIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowUpDownIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
