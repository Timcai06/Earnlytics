...
export default function LoginPageClient() {
  ...
  return (
    <AuthLayout title="登录账户" subtitle="欢迎回来，继续您的财报分析之旅">
      <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="remember" className="text-sm text-text-tertiary cursor-pointer">
              记住我
            </Label>
          </div>
          <Link
      ...
      <p className="mt-8 text-center text-sm text-text-tertiary">
        还没有账户？{" "}
        <Link href="/signup" className="font-medium text-primary transition-colors hover:text-primary-hover hover:underline">
          立即注册
        </Link>
      </p>
    </AuthLayout>
